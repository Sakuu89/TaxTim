        ...
        <div className={styles.left_right} style={{width:"80%"}}>
          ...
          <div className={styles.left_mid}>
            ...
            <div>
              ...
              <br />
              <input className={styles.input_gap}style={{ position: 'absolute',right: '200px',color:"white",backgroundColor:"#eb4f36",width:"160px",height:"32px",borderRadius:"5px"}} type="submit" value="Calculate" />
              </form>
            </div>

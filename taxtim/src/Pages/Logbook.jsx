...
import gift from "../Logbook-Images/logbook-image.gif"
const Logbook = () => {
  const logbookapp=()=>{
  ...
  return (
    <div>
      <div className='Top'>
        <img src={require('../Logbook-Images/Logbookcarlogo.png')} alt="" />
        ...
        <div className='midcontent'>
          ...
          <div className='midcontent-content'>
            ...
            <div className='midcontent-list'>
              <div>
                <img src={require('../Logbook-Images/tick.png')} alt="" />
          ...
          <div className='mid-buttons'>
            <button onClick={logbookapp}>Get Our App</button>
            <img onClick={logbookapp} src={require('../Logbook-Images/playstore.png')} alt="" />
            <img onClick={logbookapp} src={require('../Logbook-Images/appstore.png')} alt="" />
          </div>
          </div>
        </div>
      </div>

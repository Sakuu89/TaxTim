...
import image1 from '../BlogImage/firstImage.png';
import image2 from '../BlogImage/secondImage.png';

import styles from './Blog.module.css';

const Blog = () => {
    return <div>
        <div id={styles.blogDiv}>
                <h2 id={styles.head}><b>Latest Posts in TaxTim Blog</b></h2>
